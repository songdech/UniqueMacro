...
{
    public partial class DashBoardCR : UserControl
    {
        // Clinical Result or Final Result //

        ConnectString objConstr = new ConnectString();
        private String Constr = "";

        string StrThisDASHB = "CR";
        ...
        private void DashboardCR_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            Form_DashboardCR_Urgent Form_RE_UR = new Form_DashboardCR_Urgent();
        ...
        {
            // RC Routine
            Form_DashboardCR_Routine Form_RE_ROU = new Form_DashboardCR_Routine();
            Form_RE_ROU.ShowDialog();
        }
        ...
        {
            if (!backgroundWorkerCR.IsBusy)
            {
                _inputparameter.Delay = 10;
                _inputparameter.Process = 1200;
                backgroundWorkerCR.RunWorkerAsync(_inputparameter);
            }
        }
        ...
        private void backgroundWorkerCR_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (!backgroundWorkerCR.CancellationPending)
                    {
                        backgroundWorkerCR.ReportProgress(index++ * 100 / process, string.Format("Process  {0}", i));
        ...
        private void backgroundWorkerCR_ProgressChanged(object sender, System.ComponentModel.ProgressChangedEventArgs e)
        {
        ...
        private void backgroundWorkerCR_RunWorkerCompleted(object sender, System.ComponentModel.RunWorkerCompletedEventArgs e)
        {
            label1.Text = "Wait..";
        ...
        private void Process_DashboardCR()
        {
