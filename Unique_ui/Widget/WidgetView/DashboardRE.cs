...
{
    public partial class DashboardRE : UserControl
    {
        // Result Entry //
        ...
        {
            Form_DashboardRE_Urgent Form_UR = new Form_DashboardRE_Urgent();
            Form_UR.ShowDialog();
        }
        ...
        {
            // RC Routine
            Form_DashboardRE_Routine Form_ROU = new Form_DashboardRE_Routine();
            Form_ROU.ShowDialog();
        }
        ...
        private int Dashboard_Query_count_Routine()
        {
            ...
            SqlConnection objConn = dbFactory.GetDBConnection();
            StringBuilder sql = new StringBuilder();
            //sql.Append("SELECT REQSTATUS FROM REQUESTS WHERE REQUESTS.REQSTATUS='10' AND REQUESTS.URGENT='0' ");
            sql.Append("SELECT DISTINCT" +
                " MB_REQUESTS.VALIDATIONSTATUS" +
                ",REQUESTS.URGENT,REQUESTS.ACCESSNUMBER " +
                " FROM MB_REQUESTS " +
                " LEFT OUTER JOIN REQUESTS ON MB_REQUESTS.REQUESTID = REQUESTS.REQUESTID" +
                " WHERE REQUESTS.URGENT = 0 AND (MB_REQUESTS.VALIDATIONSTATUS='4' OR MB_REQUESTS.VALIDATIONSTATUS is null)");
        ...
        private int Dashboard_Query_count_Urgent()
        {
            ...
            sql.Append("SELECT DISTINCT " +
                ...
                " FROM MB_REQUESTS " +
                " LEFT OUTER JOIN REQUESTS ON MB_REQUESTS.REQUESTID = REQUESTS.REQUESTID" +
                " WHERE REQUESTS.URGENT = 1 AND (MB_REQUESTS.VALIDATIONSTATUS='4' OR MB_REQUESTS.VALIDATIONSTATUS is null)");
