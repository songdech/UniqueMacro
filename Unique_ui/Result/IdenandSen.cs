...
{
    public partial class IdenandSen : UserControl
    {

        //public DataTable MediaData { get; set; }
        ...
        private void treeAga_FocusedNodeChanged(object sender, FocusedNodeChangedEventArgs e)
        {
        ...
        private void sss(object sender, EventArgs e)
        {
