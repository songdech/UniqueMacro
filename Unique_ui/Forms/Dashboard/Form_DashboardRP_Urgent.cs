...
{
    public partial class Form_DashboardRP_Urgent : Form
    {
        ...
        public Form_DashboardRP_Urgent()
        {
            InitializeComponent();
        ...
        private void Form_DashboardRP_Urgent_Load(object sender, EventArgs e)
        {
            this.Text = Version;
        ...
        private void CreateColums_REQUESTS_Urgent(TreeList tl, DataSet ds)
        {
            //  CreateColumns
            // 0 = Patnumber
            // 1 = Accessnumber 
        ...
        private void CreateColums_MB_REQUESTS_Urgent(TreeList tl, DataSet ds)
        {
...
OR MB_REQUESTS.VALIDATIONSTATUS= '2') ORDER BY REQDATE ASC";
            ...
            try
            {
                ...
                CreateColums_REQUESTS_Urgent(treeList1, ds);
...
WHERE REQUESTS.ACCESSNUMBER = '" + StrcellACCESS + "' AND (MB_ACTIONS.ACTIONTYPE = 2 OR MB_ACTIONS.ACTIONTYPE = 1) ORDER BY MBACTIONID ASC";
            ...
            try
            {
                ...
                SqlDataReader reader = sqlCmd.ExecuteReader();
                CreateColums_MB_REQUESTS_Urgent(treeList2, ds);
