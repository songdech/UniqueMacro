...
{
    public partial class Form_DashboardCR_Urgent : Form
    {
        System.Globalization.CultureInfo cultureinfo_ENG = new System.Globalization.CultureInfo("en-US");

        private static string Version = "Clinical Result";
        ...
        public Form_DashboardCR_Urgent()
        {
            InitializeComponent();
        ...
        private void Form_DashboardCR_Urgent_Load(object sender, EventArgs e)
        {
            this.Text = Version;
            try
            {
        ...
        private void SearchData_REQUEST_Status()
        {
            ...
            sql.Append("SELECT DISTINCT" +
                ...
                " AND (MB_REQUESTS.VALIDATIONSTATUS = '1' OR MB_REQUESTS.VALIDATIONSTATUS = '3' OR MB_REQUESTS.VALIDATIONSTATUS = '4')");
