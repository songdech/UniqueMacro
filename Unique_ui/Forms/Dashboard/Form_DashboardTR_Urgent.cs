...
{
    public partial class Form_DashboardTR_Urgent : Form
    {
        System.Globalization.CultureInfo cultureinfo_ENG = new System.Globalization.CultureInfo("en-US");

        private static string Version = "Technical Result";
        ...
        public Form_DashboardTR_Urgent()
        {
            InitializeComponent();
        ...
        private void Form_DashboardTR_Urgent_Load(object sender, EventArgs e)
        {
            this.Text = Version;
        ...
        private void SearchData_REQUEST_Status()
        {
            ...
            sql.Append("SELECT DISTINCT" +
                ...
                " AND (MB_REQUESTS.VALIDATIONSTATUS = '4')");
